...
function M:cast_phrase(phrase)
	if phrase.verb == "damage" then
	elseif phrase.verb == "shield" then
	elseif phrase.verb == "strong" then
	elseif phrase.verb == "weak" then
	elseif phrase.verb == "fire" then
	elseif phrase.verb == "water" then
	elseif phrase.verb == "nature" then
	else
		assert(false, "Unhandled phrase verb: " .. phrase.verb)
	end
end
